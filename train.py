...
class ARDNet(nn.Module):
    def __init__(self):
        ...
        self.layers = nn.Sequential(
            ...
            ARDTransLayer(168, img_dim=[168, 64, 64], s=2),
            # Stage 2
            ARDStageLayer(84, 64, [84, 32, 32]),
            ARDStageLayer(138, 64, [138, 32, 32]),
            ARDStageLayer(330, 64, [330, 32, 32], has_trans_layer=False),
            ARDTransLayer(165, img_dim=[165, 32, 32], s=2),
            # Stage 3
            ARDStageLayer(82, 64, [82, 16, 16]),
            ARDStageLayer(137, 64, [137, 16, 16]),
            ARDStageLayer(164, 64, [164, 16, 16]),
            ARDStageLayer(178, 64, [178, 16, 16]),
            ARDStageLayer(185, 64, [185, 16, 16]),
            ARDStageLayer(188, 64, [188, 16, 16]),
