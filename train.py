...
class ARDNet(nn.Module):
    def __init__(self):
        ...
        self.layers = nn.Sequential(
            ...
            # Stage 2
            ARDStageLayer(336, [336, 32, 32], growth_rate=192),
            ARDStageLayer(456, [456, 32, 32], growth_rate=192),
            ARDStageLayer(516, [516, 32, 32], growth_rate=192, has_trans_layer=False),
            ARDTransLayer(1092, [1092, 32, 32], s=2),
            # Stage 3
            ARDStageLayer(546, [546, 16, 16], growth_rate=256),
            ARDStageLayer(657, [657, 16, 16], growth_rate=256),
            ARDStageLayer(712, [712, 16, 16], growth_rate=256),
            ARDStageLayer(740, [740, 16, 16], growth_rate=256),
            ARDStageLayer(754, [754, 16, 16], growth_rate=256),
            ARDStageLayer(761, [761, 16, 16], growth_rate=256),
            ARDStageLayer(764, [764, 16, 16], growth_rate=256),
            ARDStageLayer(766, [766, 16, 16], growth_rate=256),
            ARDStageLayer(767, [767, 16, 16], growth_rate=256),
            ARDStageLayer(767, [767, 16, 16], growth_rate=256),
            ARDStageLayer(767, [767, 16, 16], growth_rate=256),
            ARDStageLayer(767, [767, 16, 16], growth_rate=256),
            ARDStageLayer(767, [767, 16, 16], growth_rate=256),
            ...
            ARDStageLayer(767, [767, 16, 16], growth_rate=256),
            ARDStageLayer(767, [767, 16, 16], growth_rate=256),
            ARDStageLayer(767, [767, 16, 16], growth_rate=256, has_trans_layer=False),
